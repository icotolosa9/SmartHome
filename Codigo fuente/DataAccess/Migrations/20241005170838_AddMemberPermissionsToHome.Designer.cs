...
namespace DataAccess.Migrations
{
    ...
    [Migration("20241005170838_AddMemberPermissionsToHome")]
    partial class AddMemberPermissionsToHome
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Company1", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.Company1", b =>
                {
                    b.HasOne("Domain.CompanyOwner", "Owner")
                        .WithOne("Company")
                        .HasForeignKey("Domain.Company1", "CompanyOwnerId")
